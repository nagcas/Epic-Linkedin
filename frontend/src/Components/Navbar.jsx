    ...
    <>
      ...
      >
        <Container className='pt-1 pb-2'>
          ...
          <Navbar.Collapse
            id='basic-navbar-nav'
            className='nav-collapse pt-md-5 pt-lg-0 '
          >
            <Nav className='m-auto nav'>
              ...
              >
                <NavDropdown.Item as='div'>
                  <NavLink to='/home' className='link-dark'>
                    Profilo
                  </NavLink>
                </NavDropdown.Item>
            ...
            <Nav>
              <NavDropdown
                ...
                className='d-flex flex-column align-items-center'
              >
                <NavDropdown.Item href='#business-profile'>
                  Profilo aziendale
                </NavDropdown.Item>
                <NavDropdown.Item href='#business-settings'>
                  Impostazioni aziendali
                </NavDropdown.Item>
              </NavDropdown>
              <div className='w-50 try'>Prova Premium per 0 EUR</div>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
